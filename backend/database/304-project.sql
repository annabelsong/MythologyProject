CREATE DATABASE  IF NOT EXISTS `304-project`;
USE `304-project`;
...
CREATE TABLE Deity (
	...
	PRIMARY KEY (CharacterName),
    FOREIGN KEY (CharacterName) REFERENCES Characters
);
...
('Cernunnos','Celtic god associated with fertility, animals, wealth, and the underworld.','Fertility and Nature','Fertility, transformation','Celtic'),('Dagda','Important god in Irish mythology, associated with agriculture, fertility, and protection, known for his strength and magical club.','Fertility and Protection','Strength, plant control','Celtic'),
...
('Enki','Mesopotamian god of water, knowledge, mischief, crafts, and creation.','Water and Wisdom','Water manipulation, wisdom','Mesopotamian'),('Enlil','Mesopotamian god of wind, air, earth, and storms, considered one of the chief gods in the Mesopotamian pantheon.','Wind and Storms','Weather control','Mesopotamian'),
...
('Demon Bull King"s Cudgel', 'Rebellion of the Demon Bull King');
